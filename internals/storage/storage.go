...
type Storage interface {
	...
	// PresignGet returns a short-lived URL to fetch an object. When inline is
	// true the object is served for inline display (images); otherwise it is
	// served as a download with the given filename.
	PresignGet(ctx context.Context, key, downloadName string, inline bool) (string, error)
